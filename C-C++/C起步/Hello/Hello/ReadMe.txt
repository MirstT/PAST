...
HelloDlg.h、HelloDlg.cpp - 对话框
    这些文件包含 CHelloDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 Hello.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
...
SthAfx.h, SthAfx.cpp
    这些文件用于生成名为 Hello.pch 的预编译头 (PCH) 文件和名为 SthAfx.obj 的预编译类型文件。
