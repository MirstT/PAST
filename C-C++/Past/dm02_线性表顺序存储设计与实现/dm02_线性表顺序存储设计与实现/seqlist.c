...
SeqList* SeqList_Create(int capacity)
{
	...
	{
		ret = -1;
		printf("func SeqList_Crreat() err:%d\n", ret);
		return NULL;
	}
...
int SeqList_Insert(SeqList* list, void* node, int pos)
{
	int i = 0, ret = 0;
...
void* SeqList_Get(SeqList* list, int pos)
{
	int i =0;
	void *ret = 0;
	TSeqList *tlist = NULL;
...
void* SeqList_Delete(SeqList* list, int pos)
{
	...
	ret = (void *)tlist->node[pos]; //缓存pos的位置
